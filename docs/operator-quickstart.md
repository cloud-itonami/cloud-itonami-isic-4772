# Operator Quickstart — cloud-itonami-isic-4772

Shortest path from clone to a verified local dry-run for **ISIC 4772** (`cloud-itonami-isic-4772`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4772.git
